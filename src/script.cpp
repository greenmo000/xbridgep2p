        ...
        while (pc < pend)
        {
            ...
            switch (opcode)
            {
                ...
                case OP_HASH256:
                {
                    ...
                    {
                        uint256 hash = util::hash(vch.begin(), vch.end());
...
public:
    ...
    void Set(uint256 hash, const std::vector<unsigned char>& vchSig, const std::vector<unsigned char>& pubKey)
    {
        ...
        int64 nMaxCacheSize = 50000; // GetArg("-maxsigcachesize", 50000);
...
public:
    ...
    bool operator()(const CScriptID &scriptID) const {
        ...
        *script << OP_HASH160 << scriptID << OP_EQUAL;
        std::cerr << "Chose scriptid" << std::endl;
        return true;
    }
};
