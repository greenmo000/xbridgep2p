...
//*****************************************************************************
//*****************************************************************************
const unsigned char * XBridgeSessionEtherium::myaddr() const
{
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processInvalid(XBridgePacketPtr packet)
{
    // DEBUG_TRACE();
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processZero(XBridgePacketPtr /*packet*/)
{
    return true;
}
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processAnnounceAddresses(XBridgePacketPtr packet)
{
    return false;
//    // DEBUG_TRACE();
...
//*****************************************************************************
bool XBridgeSessionEtherium::processXChatMessage(XBridgePacketPtr packet)
{
    return false;
//    DEBUG_TRACE();
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransaction(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processTransactionHold(XBridgePacketPtr packet)
{
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionHoldApply(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
//    DEBUG_TRACE_LOG(currencyToLog());
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processTransactionInit(XBridgePacketPtr packet)
{
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionInitialized(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionCreated(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionSigned(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionCommited(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
//    DEBUG_TRACE_LOG(currencyToLog());
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processTransactionConfirm(XBridgePacketPtr packet)
{
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionConfirmed(XBridgePacketPtr packet)
{
//    DEBUG_TRACE_LOG(currencyToLog());
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processTransactionCancel(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::finishTransaction(XBridgeTransactionPtr tr)
{
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::sendCancelTransaction(const uint256 & txid)
{
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::rollbackTransaction(XBridgeTransactionPtr tr)
{
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processBitcoinTransactionHash(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
...
//*****************************************************************************
//*****************************************************************************
bool XBridgeSessionEtherium::processAddressBookEntry(XBridgePacketPtr packet)
{
//    // DEBUG_TRACE();
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::sendListOfWallets()
{
//    XBridgeExchange & e = XBridgeExchange::instance();
//    if (!e.isEnabled())
//    {
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::sendListOfTransactions()
{
//    XBridgeApp & app = XBridgeApp::instance();
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::eraseExpiredPendingTransactions()
{
//    XBridgeExchange & e = XBridgeExchange::instance();
//    if (!e.isEnabled())
//    {
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::checkFinishedTransactions()
{
//    XBridgeExchange & e = XBridgeExchange::instance();
//    if (!e.isEnabled())
//    {
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::resendAddressBook()
{
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::getAddressBook()
{
...
//*****************************************************************************
//*****************************************************************************
void XBridgeSessionEtherium::sendAddressbookEntry(const std::string & currency,
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processPendingTransaction(XBridgePacketPtr packet)
{
//    if (packet->size() != 64)
//    {
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processTransactionFinished(XBridgePacketPtr packet)
{
//    DEBUG_TRACE_LOG(currencyToLog());
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processTransactionRollback(XBridgePacketPtr packet)
{
//    DEBUG_TRACE_LOG(currencyToLog());
...
//******************************************************************************
//******************************************************************************
bool XBridgeSessionEtherium::processTransactionDropped(XBridgePacketPtr packet)
{
//    if (packet->size() != 32)
//    {
